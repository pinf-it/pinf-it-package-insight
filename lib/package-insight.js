...
function normalize(descriptorPath, descriptor, options, callback) {
	...
	try {
		...
		function extraNormalization(callback) {
				...
				if (property === "exports.main") {
					if (
						...
						return FS.exists(path, function(exists) {
							...
							// TODO: Rather than assuming `.js` see if we can detect type of package above and use corresponding extension.
							//       Even if we can detect type of package we may want to try different extensions.
							path += ".js";
							return FS.exists(path, function(exists) {
								if (exists) {
			...
			return normalize("exports.main", callback);
		}
